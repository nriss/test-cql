...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/ans.fhir.fr.test-cql|current/StructureDefinition/StructureDefinition-fr-patient.json)
