...
# ─── 2. Charger la Library (CQL encodé à la volée) ───────────────────────────
echo ""
...
curl -sf -X PUT "${FHIR_BASE}/Library/HelloCQL" \
  ...
  --data-binary @- <<EOF
{"resourceType":"Library","id":"HelloCQL","url":"http://poc-cql/Library/HelloCQL","version":"1.0.0","name":"HelloCQL","title":"Hello CQL — exemple générique","status":"active","type":{"coding":[{"system":"http://terminology.hl7.org/CodeSystem/library-type","code":"logic-library"}]},"content":[{"contentType":"text/cql","data":"${CQL_B64}"}]}
EOF
